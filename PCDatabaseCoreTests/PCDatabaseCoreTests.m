...
- (void)tearDown
{
//    [self.sharedInstance removeAllEntities:kEntityName];
...
//{
//    XCTAssertNotNil([self.sharedInstance databasePath], @"database should have path");
//}
//
...
//    NSArray *savedEntities = [self.sharedInstance createEntities:kEntityName withKey:@"dbId" andValues:dbIds inContext:self.sharedInstance.mainObjectContext];
...
//    
//    savedEntities = [self.sharedInstance createEntities:kEntityName withKey:@"dbId" andValues:dbIds inContext:self.sharedInstance.mainObjectContext];
...
//        [self.sharedInstance createEntities:kEntityName withKey:@"dbId" andValues:obj inContext:self.sharedInstance.mainObjectContext];
//    }];
//    NSInteger entityCounter = [self.sharedInstance getCountOfEntities:kEntityName];
...
//    savedEntities = [self.sharedInstance createEntities:kEntityName withKey:@"dbId" andValues:duplicatedDbIds inContext:self.sharedInstance.mainObjectContext];
...
//    [context setParentContext:self.sharedInstance.mainObjectContext];
...
//                [self.sharedInstance createEntities:kEntityName withKey:@"dbId" andValues:dbIds inContext:contexts[idx]];
//                if (counter == allThreads - 1)
//                    [self XCA_notify:XCTAsyncTestCaseStatusSucceeded];
//                else
//                    counter++;
